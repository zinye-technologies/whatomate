...
// Health/ready, auth session, /api/me, users/roles/API keys, accounts, contacts,
// tags, and conversation notes are native net/http.
// Campaigns, chatbot (+ transfers/sessions), Meta webhook, outbound webhooks, and custom actions are native.
